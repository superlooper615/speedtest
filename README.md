...
`${GOPATH}/src/github.com/superlooper615/speedtest`
...
```
git remote set-url origin https://github.com/superlooper615/speedtest
...
in the same directory with the name speedtest.
...
```
mkdir -p ${GOPATH}/src/github.com/superlooper615/speedtest
git clone https://github.com/superlooper615/speedtest ${GOPATH}/src/github.com/superlooper615/speedtest
```
